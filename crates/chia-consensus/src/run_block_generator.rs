...
///
/// Takes an allocator factory (a function that returns an Allocator) instead of
/// an allocator. Returns both the conditions and the allocator used, since
