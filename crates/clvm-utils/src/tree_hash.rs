...
mod tests {
    ...
    fn test_tree_hash_costed_equivalence_no_repeats() {
        ...
        // identical cost parameters for both versions
        ...
        let baseline = tree_hash_costed(
            &a,
            root,
            &mut cost_left_baseline,
            cost_per_call,
            cost_per_byte,
        )
        .unwrap();
        ...
        let cached2 = tree_hash_cached_costed(
            &a,
            root,
            &mut cache,
            &mut cost_left_cached2,
            cost_per_call,
            cost_per_byte,
        )
        .unwrap();
