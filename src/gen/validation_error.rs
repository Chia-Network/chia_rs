...
impl From<ErrorCode> for u32 {
    fn from(err: ErrorCode) -> u32 {
        match err {
            ...
            // TODO: introduce specific error codes on the python side
            ErrorCode::AssertBeforeSecondsAbsolute => 117,
            ErrorCode::AssertBeforeSecondsRelative => 117,
            ErrorCode::AssertBeforeHeightAbsolute => 117,
            ErrorCode::AssertBeforeHeightRelative => 117,
