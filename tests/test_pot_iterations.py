...
class TestPotIterations:
    ...
    def test_calculate_ip_iters(self):
        ...
        with raises(ValueError):
            ...
            calculate_ip_iters(test_constants.NUM_SPS_SUB_SLOT, test_constants.NUM_SP_INTERVALS_EXTRA, ssi, sp_interval_iters, sp_interval_iters)
        ...
        with raises(ValueError):
            ...
            calculate_ip_iters(test_constants.NUM_SPS_SUB_SLOT, test_constants.NUM_SP_INTERVALS_EXTRA, ssi, sp_interval_iters, uint64(0))

        required_iters = sp_interval_iters - 1
        ip_iters = calculate_ip_iters(test_constants.NUM_SPS_SUB_SLOT, test_constants.NUM_SP_INTERVALS_EXTRA, ssi, uint8(13), required_iters)
