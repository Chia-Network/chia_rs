...
class CoinStateFilters:
    ...
    def to_json_dict(self) -> Dict[str, Any]: ...
    @staticmethod
    def from_json_dict(json_dict: Dict[str, Any]) -> CoinStateFilters: ...
    def replace(self, *, include_spent: Union[ bool, _Unspec] = _Unspec(),
        include_unspent: Union[ bool, _Unspec] = _Unspec(),
        include_hinted: Union[ bool, _Unspec] = _Unspec()) -> CoinStateFilters: ...
...
class RequestAddPuzzleSubscriptions:
    ...
    def __repr__(self) -> str: ...
    def __richcmp__(self) -> Any: ...
    def __deepcopy__(self) -> RequestAddPuzzleSubscriptions: ...
    def __copy__(self) -> RequestAddPuzzleSubscriptions: ...
    @staticmethod
    def from_bytes(bytes) -> RequestAddPuzzleSubscriptions: ...
    @staticmethod
    def from_bytes_unchecked(bytes) -> RequestAddPuzzleSubscriptions: ...
    @staticmethod
    def parse_rust(ReadableBuffer, bool = False) -> Tuple[RequestAddPuzzleSubscriptions, int]: ...
    def to_bytes(self) -> bytes: ...
    def __bytes__(self) -> bytes: ...
    def stream_to_bytes(self) -> bytes: ...
    def get_hash(self) -> bytes32: ...
    def to_json_dict(self) -> Dict[str, Any]: ...
    @staticmethod
    def from_json_dict(json_dict: Dict[str, Any]) -> RequestAddPuzzleSubscriptions: ...
    def replace(self, *, puzzle_hashes: Union[ List[bytes32], _Unspec] = _Unspec(),
        min_height: Union[ int, _Unspec] = _Unspec(),
        header_hash: Union[ Optional[bytes32], _Unspec] = _Unspec()) -> RequestAddPuzzleSubscriptions: ...
...
class RespondAddPuzzleSubscriptions:
    ...
    def __repr__(self) -> str: ...
    def __richcmp__(self) -> Any: ...
    def __deepcopy__(self) -> RespondAddPuzzleSubscriptions: ...
    def __copy__(self) -> RespondAddPuzzleSubscriptions: ...
    @staticmethod
    def from_bytes(bytes) -> RespondAddPuzzleSubscriptions: ...
    @staticmethod
    def from_bytes_unchecked(bytes) -> RespondAddPuzzleSubscriptions: ...
    @staticmethod
    def parse_rust(ReadableBuffer, bool = False) -> Tuple[RespondAddPuzzleSubscriptions, int]: ...
    def to_bytes(self) -> bytes: ...
    def __bytes__(self) -> bytes: ...
    def stream_to_bytes(self) -> bytes: ...
    def get_hash(self) -> bytes32: ...
    def to_json_dict(self) -> Dict[str, Any]: ...
    @staticmethod
    def from_json_dict(json_dict: Dict[str, Any]) -> RespondAddPuzzleSubscriptions: ...
    def replace(self, *, puzzle_hashes: Union[ List[bytes32], _Unspec] = _Unspec()) -> RespondAddPuzzleSubscriptions: ...
...
class RequestAddCoinSubscriptions:
    ...
    def __repr__(self) -> str: ...
    def __richcmp__(self) -> Any: ...
    def __deepcopy__(self) -> RequestAddCoinSubscriptions: ...
    def __copy__(self) -> RequestAddCoinSubscriptions: ...
    @staticmethod
    def from_bytes(bytes) -> RequestAddCoinSubscriptions: ...
    @staticmethod
    def from_bytes_unchecked(bytes) -> RequestAddCoinSubscriptions: ...
    @staticmethod
    def parse_rust(ReadableBuffer, bool = False) -> Tuple[RequestAddCoinSubscriptions, int]: ...
    def to_bytes(self) -> bytes: ...
    def __bytes__(self) -> bytes: ...
    def stream_to_bytes(self) -> bytes: ...
    def get_hash(self) -> bytes32: ...
    def to_json_dict(self) -> Dict[str, Any]: ...
    @staticmethod
    def from_json_dict(json_dict: Dict[str, Any]) -> RequestAddCoinSubscriptions: ...
    def replace(self, *, coin_ids: Union[ List[bytes32], _Unspec] = _Unspec(),
        min_height: Union[ int, _Unspec] = _Unspec(),
        header_hash: Union[ Optional[bytes32], _Unspec] = _Unspec()) -> RequestAddCoinSubscriptions: ...
...
class RespondAddCoinSubscriptions:
    ...
    def __repr__(self) -> str: ...
    def __richcmp__(self) -> Any: ...
    def __deepcopy__(self) -> RespondAddCoinSubscriptions: ...
    def __copy__(self) -> RespondAddCoinSubscriptions: ...
    @staticmethod
    def from_bytes(bytes) -> RespondAddCoinSubscriptions: ...
    @staticmethod
    def from_bytes_unchecked(bytes) -> RespondAddCoinSubscriptions: ...
    @staticmethod
    def parse_rust(ReadableBuffer, bool = False) -> Tuple[RespondAddCoinSubscriptions, int]: ...
    def to_bytes(self) -> bytes: ...
    def __bytes__(self) -> bytes: ...
    def stream_to_bytes(self) -> bytes: ...
    def get_hash(self) -> bytes32: ...
    def to_json_dict(self) -> Dict[str, Any]: ...
    @staticmethod
    def from_json_dict(json_dict: Dict[str, Any]) -> RespondAddCoinSubscriptions: ...
    def replace(self, *, coin_ids: Union[ List[bytes32], _Unspec] = _Unspec()) -> RespondAddCoinSubscriptions: ...
...
class RequestRemovePuzzleSubscriptions:
    ...
    def to_json_dict(self) -> Dict[str, Any]: ...
    @staticmethod
    def from_json_dict(json_dict: Dict[str, Any]) -> RequestRemovePuzzleSubscriptions: ...
    def replace(self, *, puzzle_hashes: Union[ List[bytes32], _Unspec] = _Unspec()) -> RequestRemovePuzzleSubscriptions: ...
...
class RespondRemovePuzzleSubscriptions:
    ...
    def to_json_dict(self) -> Dict[str, Any]: ...
    @staticmethod
    def from_json_dict(json_dict: Dict[str, Any]) -> RespondRemovePuzzleSubscriptions: ...
...
class RequestRemoveCoinSubscriptions:
    ...
    def to_json_dict(self) -> Dict[str, Any]: ...
    @staticmethod
    def from_json_dict(json_dict: Dict[str, Any]) -> RequestRemoveCoinSubscriptions: ...
    def replace(self, *, coin_ids: Union[ List[bytes32], _Unspec] = _Unspec()) -> RequestRemoveCoinSubscriptions: ...
...
class RespondRemoveCoinSubscriptions:
    ...
    def to_json_dict(self) -> Dict[str, Any]: ...
    @staticmethod
    def from_json_dict(json_dict: Dict[str, Any]) -> RespondRemoveCoinSubscriptions: ...
    def replace(self, *, coin_ids: Union[ List[bytes32], _Unspec] = _Unspec()) -> RespondRemoveCoinSubscriptions: ...

class RequestResetSubscriptions:
    def __init__(
        self
    ) -> None: ...
    def __hash__(self) -> int: ...
    def __repr__(self) -> str: ...
    def __richcmp__(self) -> Any: ...
    def __deepcopy__(self) -> RequestResetSubscriptions: ...
    def __copy__(self) -> RequestResetSubscriptions: ...
    @staticmethod
    def from_bytes(bytes) -> RequestResetSubscriptions: ...
    @staticmethod
    def from_bytes_unchecked(bytes) -> RequestResetSubscriptions: ...
    @staticmethod
    def parse_rust(ReadableBuffer, bool = False) -> Tuple[RequestResetSubscriptions, int]: ...
    def to_bytes(self) -> bytes: ...
    def __bytes__(self) -> bytes: ...
    def stream_to_bytes(self) -> bytes: ...
    def get_hash(self) -> bytes32: ...
    def to_json_dict(self) -> Dict[str, Any]: ...
    @staticmethod
    def from_json_dict(json_dict: Dict[str, Any]) -> RequestResetSubscriptions: ...

class RespondResetSubscriptions:
    puzzle_hashes: List[bytes32]
    coin_ids: List[bytes32]
    def __init__(
        self,
    ...
    def __repr__(self) -> str: ...
    def __richcmp__(self) -> Any: ...
    def __deepcopy__(self) -> RespondResetSubscriptions: ...
    def __copy__(self) -> RespondResetSubscriptions: ...
    @staticmethod
    def from_bytes(bytes) -> RespondResetSubscriptions: ...
    @staticmethod
    def from_bytes_unchecked(bytes) -> RespondResetSubscriptions: ...
    @staticmethod
    def parse_rust(ReadableBuffer, bool = False) -> Tuple[RespondResetSubscriptions, int]: ...
    def to_bytes(self) -> bytes: ...
    def __bytes__(self) -> bytes: ...
    def stream_to_bytes(self) -> bytes: ...
    def get_hash(self) -> bytes32: ...
    def to_json_dict(self) -> Dict[str, Any]: ...
    @staticmethod
    def from_json_dict(json_dict: Dict[str, Any]) -> RespondResetSubscriptions: ...
    def replace(self, *, puzzle_hashes: Union[ List[bytes32], _Unspec] = _Unspec(),
        coin_ids: Union[ List[bytes32], _Unspec] = _Unspec()) -> RespondResetSubscriptions: ...
...
class RequestPuzzleState:
    ...
    def to_json_dict(self) -> Dict[str, Any]: ...
    @staticmethod
    def from_json_dict(json_dict: Dict[str, Any]) -> RequestPuzzleState: ...
    def replace(self, *, puzzle_hashes: Union[ List[bytes32], _Unspec] = _Unspec(),
        min_height: Union[ int, _Unspec] = _Unspec(),
        header_hash: Union[ Optional[bytes32], _Unspec] = _Unspec(),
...
class RespondPuzzleState:
    ...
    def to_json_dict(self) -> Dict[str, Any]: ...
    @staticmethod
    def from_json_dict(json_dict: Dict[str, Any]) -> RespondPuzzleState: ...
    def replace(self, *, puzzle_hashes: Union[ List[bytes32], _Unspec] = _Unspec(),
        next_height: Union[ int, _Unspec] = _Unspec(),
        next_header_hash: Union[ bytes32, _Unspec] = _Unspec(),
...
class RejectPuzzleState:
    ...
    def to_json_dict(self) -> Dict[str, Any]: ...
    @staticmethod
    def from_json_dict(json_dict: Dict[str, Any]) -> RejectPuzzleState: ...
    def replace(self, *, header_hash: Union[ Optional[bytes32], _Unspec] = _Unspec()) -> RejectPuzzleState: ...
...
class RequestCoinState:
    ...
    def to_json_dict(self) -> Dict[str, Any]: ...
    @staticmethod
    def from_json_dict(json_dict: Dict[str, Any]) -> RequestCoinState: ...
    def replace(self, *, coin_ids: Union[ List[bytes32], _Unspec] = _Unspec(),
...
class RespondCoinState:
    ...
    def to_json_dict(self) -> Dict[str, Any]: ...
    @staticmethod
    def from_json_dict(json_dict: Dict[str, Any]) -> RespondCoinState: ...
    def replace(self, *, coin_ids: Union[ List[bytes32], _Unspec] = _Unspec(),
