...
def tree_hash_2026(blob: ReadableBuffer) -> bytes32: ...
...
def get_puzzle_and_solution_for_coin_2026(generator: ReadableBuffer, block_refs: Sequence[ReadableBuffer], max_cost: int, find_coin_parent: bytes32, find_coin_amount: int, find_coin_puzzle_hash: bytes32, flags: int) -> tuple[Program, Program]: ...
