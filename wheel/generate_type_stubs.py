...
def get_puzzle_and_solution_for_coin_2026(generator: ReadableBuffer, block_refs: Sequence[ReadableBuffer], max_cost: int, find_coin: Coin, flags: int) -> tuple[Program, Program]: ...
