...
def create_v2_single_plot_group(filename: str,
    k: int,
    strength: int,
...
def validate_proof_v2(plot_group_id: bytes32, plot_index: uint16, size: int, plot_strength: int, meta_group: uint8, challenge: bytes32, proof: bytes) -> Optional[bytes32]: ...
