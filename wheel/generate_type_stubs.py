...
class MerkleSet:
    ...
    def check_proof(self, proof: bytes) -> MerkleSet: ...
    def __init__(
        self,
        leafs: List[bytes32],
    ) -> None: ...
    ...
    def __repr__(self) -> str: ...
    def __richcmp__(self) -> Any: ...
    def __deepcopy__(self) -> MerkleSet: ...
    def __copy__(self) -> MerkleSet: ...
    @staticmethod
    def from_bytes(bytes) -> MerkleSet: ...
    @staticmethod
    def from_bytes_unchecked(bytes) -> MerkleSet: ...
    @staticmethod
    def parse_rust(ReadableBuffer, bool = False) -> Tuple[MerkleSet, int]: ...
    def to_bytes(self) -> bytes: ...
    def __bytes__(self) -> bytes: ...
    def stream_to_bytes(self) -> bytes: ...
    def get_hash(self) -> bytes32: ...
    def to_json_dict(self) -> Any: ...
    @staticmethod
    def from_json_dict(json_dict: Any) -> MerkleSet: ...
