...
from typing import List, Optional, Tuple, ClassVar, Any, Union, Object
...
class OwnedSpendBundleConditions:
    spends: List[OwnedSpend]
    reserve_fee: uint64
    ...
    def __deepcopy__(self) -> OwnedSpendBundleConditions: ...
    def __copy__(self) -> OwnedSpendBundleConditions: ...
    @staticmethod
    def from_bytes(buffer: bytes) -> OwnedSpendBundleConditions: ...
    @staticmethod
    def from_bytes_unchecked(buffer: bytes) -> OwnedSpendBundleConditions: ...
    @staticmethod
    def parse_rust(buffer: ReadableBuffer, trusted: bool = False) -> Tuple[OwnedSpendBundleConditions, int]: ...
    ...
    @staticmethod
    def from_json_dict(json_dict: Any) -> OwnedSpendBundleConditions: ...
...
class OwnedSpend:
    ...
    def __repr__(self) -> str: ...
    def __richcmp__(self) -> Any: ...
    def __deepcopy__(self) -> OwnedSpend: ...
    def __copy__(self) -> OwnedSpend: ...
    @staticmethod
    def from_bytes(buffer: bytes) -> OwnedSpend: ...
    @staticmethod
    def from_bytes_unchecked(buffer: bytes) -> OwnedSpend: ...
    @staticmethod
    def parse_rust(buffer: ReadableBuffer, trusted: bool = False) -> Tuple[OwnedSpend, int]: ...
    def to_bytes(self) -> bytes: ...
    def __bytes__(self) -> bytes: ...
    def stream_to_bytes(self) -> bytes: ...
    def get_hash(self) -> bytes32: ...
    def to_json_dict(self) -> Any: ...
    @staticmethod
    def from_json_dict(json_dict: Any) -> OwnedSpend: ...
