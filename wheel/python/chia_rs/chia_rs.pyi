...
def generator_tree_hash(program: ReadableBuffer) -> bytes: ...
def generator_cost_and_hash(program: ReadableBuffer) -> tuple[int, bytes]: ...
...
class ConsensusConstants:
    ...
    HARD_FORK_TREE_GENERATOR_HEIGHT: uint32
    def __new__(
        cls,
        SLOT_BLOCKS_TARGET: uint32,
        MIN_BLOCKS_PER_CHALLENGE_BLOCK: uint8,
    ...
    def replace(self, *, SLOT_BLOCKS_TARGET: Union[ uint32, _Unspec] = _Unspec(),
        ...
        HARD_FORK_TREE_GENERATOR_HEIGHT: Union[ uint32, _Unspec] = _Unspec()) -> ConsensusConstants: ...
