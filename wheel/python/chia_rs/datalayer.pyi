...
class ProofOfInclusionLayer:
    ...
    @staticmethod
    def from_hashes(primary_hash: bytes32, other_hash_side: uint8, other_hash: bytes32) -> ProofOfInclusionLayer: ...
...
class DeltaReader:
    ...
    def create_merkle_blob_and_filter_unused_nodes(self, root_hash: bytes32, interested_hashes: set[bytes32]) -> tuple[MerkleBlob, list[tuple[bytes32, TreeIndex]]]: ...
